...
exports.getPendaftaranForm = (req, res, next) => {
    if (typeof req.session.username === 'undefined') {
      ...
      if (req.params.page) {
        inputPendaftaranForm(req.session.username, req.session.token, req.params.page, res, req)
      } else {
        inputPendaftaranForm(req.session.username, req.session.token, '1', res, req)
      }
    }
    
};

inputPendaftaranForm = (username, token, page, res, req) => {
    res.render('pendaftaran-form/index', {
