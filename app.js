...
const usmUmumRoutes = require('./routes/usmUmum');
const usmProdiRoutes = require('./routes/usmProdi');
...
const perguruanTinggiRoutes = require('./routes/perguruanTinggi');
const statusAwalRoutes = require('./routes/statusAwal');
...
// route tabel simak_mst_pmb_persyaratan
app.use(usmUmumRoutes)

// route tabel simak_mst_pmb_persyaratan
app.use(usmProdiRoutes)
...
// route tabel simak_trn_pmb_formulir
app.use(perguruanTinggiRoutes)

// route tabel simak_trn_pmb_formulir
app.use(statusAwalRoutes)
